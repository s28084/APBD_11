...
namespace JWT.Controllers
{
    ...
    public class TutorialController(IConfiguration config) : ControllerBase
    {
        ...
        {
            if (model.UserName.ToLower() == "kacper")
            {
            ...
            var hashedPassword = passwordHasher.HashPassword(new User { Name = model.UserName }, model.Password);
    ...
    public class RefreshTokenRequestModel       //model refreshedToken
    {
        public string RefreshToken { get; set; } = null!;
    }

    
    public class VerifyPasswordRequestModel     //model uwierzytalniania hasła
    {
        public string Password { get; set; } = null!;
        public string Hash { get; set; } = null!;
    }
    
    public class LoginRequestModel      //model logowania
    {
        [Required]
    ...
    public class LoginResponseModel     //model tokenów
    {
    ...
    public class User   //model użytkownika
    {
